...
oriented multilamellar bilayes (ORI)~\cite{Lyatskaya.2001,kucerka05} and un-oriented multilamellar vesicles (MLVs)~\cite{Heftberger.2014}.
...
(for in-plane and out-of-plane scattering constributions) to the measured scattering intensity~\cite{Lyatskaya.2001,kucerka05}.
