...
gives structural and dynamical interpretation for the experimental data. Significant advance of MD 
models is the joint interpretation of different experiments with the same model.
Here we particularly focus on the atomistic resolution structure of phosphatidylcholine lipid bilayers 
due to the large available datasets, in both experiments and simulations.
