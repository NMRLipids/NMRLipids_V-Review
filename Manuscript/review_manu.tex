...
mesured from living cells, lipid extracts and model systems \cite{gally81,scherer87}. 
...
However, the basic ideas of the approach is valid also for other molecules \cite{kapla12,nowacka13,ferreira14}. 
...
\todo{This should be close to final now. The text and figures should polished though.}
...
only interval lengths less than half of the total simulation length are typically used; for more details see~\cite{gromacsMANUAL}.
